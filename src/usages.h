/*
 * Copyright (C) 2017-2020, 2022-2023 ARM Limited. All rights reserved.
 *
...
typedef enum
{
	...
	MALI_GRALLOC_USAGE_CHROMA_SITING_CENTER = GRALLOC_USAGE_PRIVATE_8,
	MALI_GRALLOC_USAGE_CHROMA_SITING_COSITED = GRALLOC_USAGE_PRIVATE_9,
	MALI_GRALLOC_USAGE_CHROMA_SITING_CENTER_X = GRALLOC_USAGE_PRIVATE_10,
	MALI_GRALLOC_USAGE_CHROMA_SITING_CENTER_Y = GRALLOC_USAGE_PRIVATE_8 | GRALLOC_USAGE_PRIVATE_9,
	MALI_GRALLOC_USAGE_CHROMA_SITING_MASK =
	    (GRALLOC_USAGE_PRIVATE_8 | GRALLOC_USAGE_PRIVATE_9 | GRALLOC_USAGE_PRIVATE_10),
