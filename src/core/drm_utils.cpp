...
const static std::unordered_map<mali_gralloc_internal_format, uint32_t> table = {
	...
	{ MALI_GRALLOC_FORMAT_INTERNAL_RG16, DRM_FORMAT_GR1616 },

	/* Depth / stencil formats */
	{ MALI_GRALLOC_FORMAT_INTERNAL_DEPTH_16, DRM_FORMAT_RG88 },
	{ MALI_GRALLOC_FORMAT_INTERNAL_DEPTH_24_STENCIL_8_AFBC, DRM_FORMAT_RGB888_A8 },
	{ MALI_GRALLOC_FORMAT_INTERNAL_DEPTH_32F, DRM_FORMAT_RGBA8888 }
};
